...
import (
	"bufio"
	"dersnek/task-7/pkg/crawler"
	"dersnek/task-7/pkg/crawler/spider"
	"dersnek/task-7/pkg/engine"
	"dersnek/task-7/pkg/index"
	"dersnek/task-7/pkg/index/hash"
	"dersnek/task-7/pkg/store"
	"dersnek/task-7/pkg/store/file"
	"fmt"
	"log"
	"os"
)
